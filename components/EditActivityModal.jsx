...
export default function EditActivityModal({
    ...
    const handleDelete = async () => {
        ...
        const participantCount = activity.totalParticipants || activity.eligibleDepartments?.length || 0;
        const confirmMessage = `Are you sure you want to delete "${activity.companyName || activity.name}"? This will permanently remove the activity and all ${participantCount} participant records. This action cannot be undone.`;
