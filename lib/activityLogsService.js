...
export const ACTIVITY_LOG_CATEGORIES = {
  ...
  ATTENDANCE_SCANNING: ['MARK_ATTENDANCE', 'BULK_ATTENDANCE_UPDATE', 'SCAN_ADMISSION_NUMBER', 'BULK_SCAN_ADMISSIONS', 'REMOVE_SCANNED_ADMISSION', 'COMPLETE_SCANNING_SESSION'],
