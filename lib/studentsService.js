...
export const studentsService = {
  ...
  async searchByAdmissionNumber(admissionNumber) {
    try {
        ...
        try {
          ...
          if (!querySnapshot.empty) {
            ...
            return {
              ...
              searchMethod: "optimized_section_mapping"
            };
          }
        } catch (error) {
        ...
        try {
          ...
          if (!querySnapshot.empty) {
            ...
            return {
              ...
              searchMethod: "fallback_all_collections"
            };
          }
        } catch (error) {
      ...
      return {
        ...
        searchMethod: targetCollection ? "optimized_with_fallback" : "fallback_only",
        targetCollection: targetCollection
      };
    } catch (error) {
      console.error("Error in optimized admission number search:", error);
      return {
        found: false,
  ...
  // Legacy batch search for multiple admission numbers (for backwards compatibility)
